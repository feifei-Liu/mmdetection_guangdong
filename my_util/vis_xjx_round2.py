from vis_gt_round2 import DataAnalyze
...
class Config:
    def __init__(self):
        ...
        self.json_paths = [
                ...
                # '/home/remo/test/Aug_json.json',
                '/home/zhangming/Models/Results/cloth_flaw_detection/Datasets_2/layout/train_maxgt100_925.json'
        ] # 训练json

        # self.allimg_path = '/home/remo/test' # 训练 图片地址
        self.allimg_path = '/home/zhangming/Models/Results/cloth_flaw_detection/Datasets_2/defect_images' # 训练 图片地址
        ...
        # ---------------------aug path, json -----------------------------------
        self.aug_save_path = '/home/zhangming/Models/Results/cloth_flaw_detection/Datasets_2/train_maxgt100_925_augto1000'
        # self.json_file_path = '/home/remo/Desktop/cloth_flaw_detection/Dataset/COCO_format/Aug_json.json'
        self.json_file_path = '/home/zhangming/Models/Results/cloth_flaw_detection/Datasets_2/layout/train_maxgt100_925_augto1000.json'
        self.add_num = 1000
