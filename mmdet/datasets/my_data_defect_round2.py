...
class MyDataset_defect_round2(CocoDataset):
    ...
    def data2coco(self,anno_file):
        ...
        img_dir = "/home/zhangming/Models/Results/cloth_flaw_detection/Datasets_2/defect_images"  # 图片路径
        save_dir = "/home/zhangming/Models/Results/cloth_flaw_detection/Datasets_2/Coco_json/" # 待保存的coco格式json路径
        defect_name2label = {
