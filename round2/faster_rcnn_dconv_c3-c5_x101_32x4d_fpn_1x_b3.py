...
model = dict(
	...
	anchor_scales=[8],
        ...
        extra_small_box_scales = [4],  # scale*stride extra small box
        extra_small_box_ratios = [0.25, 1.0, 4.0],
...
log_level = 'INFO'
work_dir = './work_dirs/faster_rcnn_dconv_c3-c5_x101_32x4d_fpn_1x_b3'
