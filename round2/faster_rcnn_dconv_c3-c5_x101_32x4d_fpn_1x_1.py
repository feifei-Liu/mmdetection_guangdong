...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'guangdong1_round2_train_part1_20190924/Annotations/new_anno_train_20190925.json',
...
log_level = 'INFO'
work_dir = './work_dirs_defect_round2/faster_rcnn_dconv_c3-c5_x101_32x4d_fpn_1x_1'
