...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='/home/zhangming/Models/Results/cloth_flaw_detection/Datasets/guangdong1_round1_train1_20190818/Annotations/anno_train.json',
...
log_level = 'INFO'
work_dir = './work_dirs/faster_rcnn_dconv_c3-c5_x101_32x4d_fpn_1x_48_fix_val'
